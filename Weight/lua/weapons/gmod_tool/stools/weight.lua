...
if CLIENT then
	...
	language.Add( "Tool.weight_set", "Weight:" )
	language.Add( "Tool.weight_set.desc", "Set the weight" )
	language.Add( "Tool.weight_zeromass", "Mass must be above 0!" )
end
...
function TOOL.BuildCPanel( cp )
	...
	cp:AddControl("Slider", { Label = "#Tool.weight_set", Type = "Numeric", Min = "1", Max = "50000", Command = "weight_set" } )
end
...
if CLIENT then
	...
	surface.CreateFont( "GModWorldtip", fontTable )
	...
	function ZMass()
		...
		GAMEMODE:AddNotify("#Tool.weight_zeromass", NOTIFY_ERROR, 6);
